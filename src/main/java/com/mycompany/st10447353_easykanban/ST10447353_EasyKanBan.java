package com.mycompany.st10447353_easykanban;

import java.util.ArrayList; 
import javax.swing.JOptionPane;

public class ST10447353_EasyKanBan {
...
public Task(String TaskName,String description, String developerFirstName, String developerLastName, double estimatedDuration, String status) {
            ...
            public static void main(String[] args) {
                ...
                for ((int numTask [1] = 0; 1 < numTasks; 1++ {
                    ...
                    String estimatedDuration = JOptionPane.showInputDialog("Enter developer last name");
